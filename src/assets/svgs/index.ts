...
import DocumentationICon from './documentation.svg';
import AdministrationsICon from './administrations.svg';
...
import ArrowSquareOutICon from './arrow-square-out.svg';
import BooksIcon from './books.svg';
import ChartIcon from './chart.svg';
import NotePencilIcon from './note-pencil.svg';
